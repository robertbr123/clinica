<?php
	...
	/**
	 * Classe das Especialidades dos Dentistas das cl�nicas
	 *
	 */
	...
	/**
	 * Classe dos dentistas das cl�nicas
	 *
	 */
	class TDentistas {
		private $dados;
	...
	/**
	 * Classe dos pacientes da cl�nica
	 *
	 */
	class TPacientes {
		private $dados;
	...
	/**
	 * Classe dos Funcion�rios da cl�nica
	 *
	 */
	class TFuncionarios {
		private $dados;
	...
	/**
	 * Classe dos Fornecedores da cl�nica
	 *
	 */
	class TFornecedores {
		private $dados;
	...
	/**
	 * Classe dos Laborat�rios Cl�nicos
	 *
	 */
	class TLaboratorio {
		private $dados;
	...
	/**
	 * Classe do livro caixa da cl�nica e 
	 * dos funcion�rios
	 * 
	 */
	class TCaixa {
	...
	/**
	 * Classe dos Patrim�nios da Cl�nica
	 *
	 */
	class TPatrimonios {
		private $dados;
	...
	/**
	 * Classe do controle da tablea de honor�rios
	 *
	 */
	class THonorarios {
		private $dados;
	...
	/**
	 * Classe para controle de or�amento
	 * 
	 */
	class TOrcamento {
		private $dados;
	...
	/**
	 * Classe dos exames objetivos dos pacientes da cl�nica
	 *
	 */
	class TExObjetivo {
		private $dados;
	...
	/**
	 * Classe da evolu��o no tratamento dos pacientes da cl�nica
	 *
	 */
	class TEvolucao {
		private $dados;
	...
	/**
	 * Classe dos inqu�ritos de sa�de dos pacientes da cl�nica
	 *
	 */
	class TInquerito {
		private $dados;
	...
	/**
	 * Classe da Ortodontia dos pacientes da cl�nica
	 *
	 */
	class TOrtodontia {
		private $dados;
	...
	/**
	 * Classe da Implantodontia dos pacientes da cl�nica
	 *
	 */
	...
	/**
	 * Classe dos dados da cl�nica para cabe�alhos
	 *
	 */
	class TClinica {
        private $cnpj;
...
1(uma) c�psula de 8(oito) em 8(oito) horas durante 7(sete) dias
...
1(um) comprimido de 4(quatro) em 4(quatro) horas durante 2(dois) dias ou quando houver dor.', ";
	...
	class TAtestado {
		...
		function SalvarNovo() {
            ...
            $sql .= "VALUES ('Atesto para fins trabalhistas e/ou escolares que o paciente supracitada esteve sob meus cuidados durante este dia realizando uma cirurgia oral avan�ada de exodontia (extra��o) de dentes cisos, e dever� ficar 4(quatro) dias em repouso absoluto a partir desta data.


Ressalto que este repouso ser� importante para o sucesso do tratamento e tranquilidade p�s-operat�ria.



Sem mais, fico a disposi��o para quaisquer esclarecimentos.





CID (C�digo Internacional de Doen�as) = K07.3', ";
            $sql .= "'".$this->Codigo_Paciente."')";
	...
	class TExame {
		...
		function SalvarNovo() {
            ...
            $sql .= "VALUES ('Solicito para o(a) paciente supracitado os seguintes exames laboratoriais para finalidade de tratamento odontol�gico:
...
Encaminho o(a) paciente para a realiza��o de um tratamento endod�ntico no dente 26 conforme imagem radiogr�fica vis�vel na radiografia em anexo.

Fico a disposi��o para qualquer esclarecimento.
...
Atenciosamente.', ";
	...
	class TLaudo {
		...
		function SalvarNovo() {
            ...
            $sql .= "VALUES ('Paciente apresenta-se com les�o periapical radiol�cida sugestiva de cisto.

Recomendamos que fa�a o tratamento adequado para a regress�o desta les�o.

Fico � disposi��o para qualquer esclarecimento.
...
Atenciosamente.', ";
	...
	class TAgradecimento {
		...
		function SalvarNovo() {
            ...
            $sql .= "VALUES ('Agrade�o o encaminhamento do(a) paciente em quest�o e encaminho de volta para a continuidade do tratamento ap�s ter executado todo o tratamento solicitado.

Fico � disposi��o para esclarecimentos.
